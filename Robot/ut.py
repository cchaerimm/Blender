...
def select(objName):
    bpy.ops.objects.select_all(action="DELECT")
...
class sel:
    """Funtion Class for operating on SELECTED objects"""
...
class spec:
    """Function Class for operating on SPECIFIED objcts"""
    ...
    def rotation(objName, v):
        bpy.data.objects[objName].roataion_euler = v
